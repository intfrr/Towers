...
public class LargeShell extends Projectile {

  private static double velocity = 75.0; 
  private Color color = Color.RED;
  
  public LargeShell(Bunker owner, int x, int y, double bearing) {
    super(owner, new Vector2D(new Location(x, y), velocity, bearing), 4, 20);
  }
